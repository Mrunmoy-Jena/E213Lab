...
\begin{table}[h!]
    \centering
    \caption[Integrated luminosity values for \textit{data6.root} and radiative and $\text{A}_{\text{FB}}$ corrections for different $\sqrt{s}$ values]{Integrated luminosity values for \textit{data6.root} and radiative and $\text{A}_{\text{FB}}$ corrections for different $\sqrt{s}$ values\cite{UB}.}
    \begin{tabular}{|c|cccc|}
    \hline
